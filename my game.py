...
clock = pygame.time.Clock()
background_image = pygame.image.load("C://Users/Giri/Downloads/img/bg.jpg").convert()
font1 = pygame.font.SysFont("Rockwell", 45)
text1 = font1.render("Chain Reaction", True, (10,10,9))
red = (154, 237, 186)
while(dead==False):
    for event in pygame.event.get():
        if event.type == pygame.QUIT:
    ...
    screen.blit(text1,(250-text1.get_width()//2,0))
    if 250+100 > mouse[0] > 250 and 200+40 > mouse[1] > 200:
        pygame.draw.rect(screen, (50, 240, 123),(250,200,100,40))
        if click[0] == 1 and gamestart != None:
            gamestart()
    else:
        pygame.draw.rect(screen, red,(250,200,100,40))
    font = pygame.font.SysFont("Rockwell", 15)
    text = font.render("Play", True, (10,10,9))
    screen.blit(text,(300-text.get_width()//2,220-text.get_height()//2))
    if 200+100 > mouse[0] > 200 and 250+40 > mouse[1] > 220:
        pygame.draw.rect(screen, (50, 240, 123),(200,250,100,40))
    else:
        pygame.draw.rect(screen, red,(250,250,100,40))
    text2 = font.render("Quit", True, (10,10,9))
    screen.blit(text2,(300-text2.get_width()//2,270-text2.get_height()//2))
    if 250+100 > mouse[0] > 250 and 300+40 > mouse[1] > 300:
        pygame.draw.rect(screen, (50, 240, 123),(250,300,100,40))
    else:
        pygame.draw.rect(screen, red,(250,300,100,40))
    pygame.display.update()
